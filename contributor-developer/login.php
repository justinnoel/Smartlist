...
header("Location: https://smartlist.ga/contribute/");
exit;
}
try {
$db = new PDO('mysql:host=localhost;dbname=bcxkspna_test;charset=utf8mb4', '', '');
...
$sql = "SELECT * FROM login WHERE name=".$_SESSION['id']; 
$users = $dbh->query($sql); 
...
VALUES('$loginId','".$_SESSION['email']."','".$_SESSION['name']."', '')";
$conn->exec($sql);
...
<p>You are accessing the contributor page! </p>
...
Not a contributor yet? <a href="register.php">Sign Up!</a>
</div>
</div>
