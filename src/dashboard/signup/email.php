...
<center>
  ...
  <p>Didn't recieve an email? <a href="javascript:void(0)" class="blue-text" onclick="$('#ajaxLoader').load('https://smartlist.ga/dashboard/signup/email.php?id=<?=$_SESSION['re_id'];?>&email',() => {M.toast({html:'Sent email! Might take up to 5 minutes to arrive. Make sure to check your spam folder.'})})" style="color:blue!important">Resend</a></p>
  <p>Incorrect email? <a href="javascript:void(0)" class="blue-text" onclick="var d=prompt('Enter your email');if(validateEmail(d)){$('#ajaxLoader').load('https://smartlist.ga/dashboard/signup/change-email.php?email='+d, (e) => {alert(e);M.toast({html:'Updated email!'})})} else {M.toast({html:'Please enter a valid email!'})}" style="color:blue!important">Change</a></p>
...
<html lang="en-US">
                ...
                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                    <td style="padding:0 35px;">
                      ...
                      <a href="https://smartlist.ga/dashboard/user/verify-new-account.php?u='.urlencode(hash('sha256', $_SESSION['re_id'])).'"
  ...
  ';
  $mail->AltBody = 'Welcome to Smartlist! Click on the link below to get started: https://smartlist.ga/dashboard/user/verify-new-account.php?u='.urlencode(hash('sha256', $_SESSION['re_id']));
