...
try {
    ...
    $sql = $dbh->prepare("SELECT * FROM login WHERE username=:name");
    ...
    if (count($users) == 0) {
        try {
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                              ...
                              <tr>
                                <td style="padding:0 35px;">
                                  ...
                                  <a href="https://smartlist.ga/dashboard/resources/verifynewaccount.php?u=' .
            ...
            $mail->AltBody = 'Click here to verify your login: https://smartlist.ga/dashboard/resources/verifynewaccount.php?u='. urlencode(hash("sha256", $USERID));
