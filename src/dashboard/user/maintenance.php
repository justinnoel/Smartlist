...
<div class="container">
  <div class="row">
    ...
    <br><br>
      ...
      <br>
      <button onclick="$('#app').load('./user/maintenance.php?card')" class="btn red darken-3 waves-effect waves-light btn-round">Cancel</button>
...
<div class="container">
  ...
  <?php
    ...
    case "Aug":
  ?>
  <div class="row"> <div class="col s12 m6"> <div class="card mcard"> <div class="card-image"> <img class="materialboxed"  src="https://crownlinen.com/wp-content/uploads/2018/08/hotel-bed-making.jpg"> </div> <div class="card-content"> <span class="card-title">Make your beds</span> <p>Wash and fold your blankets</p> </div> <div class="card-action"> <a class="btn-round btn btn-flat waves-effect" href="javascript:void(0)" onclick="$('#app').load('./user/maintenance.php?q='+encodeURI('Make your beds'))">View More</a> </div> </div> </div> <div class="col s12 m6"> <div class="card mcard"> <div class="card-image"> <img class="materialboxed"  src="https://cf.ltkcdn.net/cleaning/images/orig/257114-1600x1030-how-properly-do-laundry.jpg"> </div> <div class="card-content"> <span class="card-title">Do your laundry</span> <p>Fold the clothes in your laundry room</p> </div> <div class="card-action"> <a class="btn-round btn btn-flat waves-effect" href="javascript:void(0)" onclick="$('#app').load('./user/maintenance.php?q=' + encodeURI('Do your laundry'))">View More</a> </div> </div> </div> </div> <div class="row"> <div class="col s12 m6"> <div class="card mcard"> <div class="card-image"> <img class="materialboxed"  src="https://images.squarespace-cdn.com/content/v1/586d72eacd0f6848a35cf3b9/1571361411554-8ZJ1X9K78X8Y6S2YWVOR/ke17ZwdGBToddI8pDm48kLkXF2pIyv_F2eUT9F60jBl7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0iyqMbMesKd95J-X4EagrgU9L3Sa3U8cogeb0tjXbfawd0urKshkc5MgdBeJmALQKw/IMG_20180925_0901086.jpg?format=2500w"> </div> <div class="card-content"> <span class="card-title">Check and Vacuum floors</span> <p>Make sure that there aren't any loose tiles in your flooring</p> </div> <div class="card-action"> <a class="btn-round btn btn-flat waves-effect" href="javascript:void(0)" onclick="$('#app').load('./user/maintenance.php?q='+encodeURI('Check and Vacuum floors'))">View More</a> </div> </div> </div> <div class="col s12 m6"> <div class="card mcard"> <div class="card-image"> <img class="materialboxed"  src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/cleaning-gutters-during-the-summer-royalty-free-image-485292592-1541689661.jpg"> </div> <div class="card-content"> <span class="card-title">Clean your gutters</span> <p>Remove any dirt from your gutters</p> </div> <div class="card-action"> <a class="btn-round btn btn-flat waves-effect" href="javascript:void(0)" onclick="$('#app').load('./user/maintenance.php?q=' + encodeURI('Clean your gutters'))">View More</a> </div> </div> </div> </div> <div class="row"> <div class="col s12 m6"> <div class="card mcard"> <div class="card-image"> <img class="materialboxed"  src="https://chopmytree.com/wp-content/uploads/2015/06/tree-pruning.jpg"> </div> <div class="card-content"> <span class="card-title">Prune your plants</span> <p>Remove any excess branches or dying branches. Let them grow the upcoming months</p> </div> <div class="card-action"> <a class="btn-round btn btn-flat waves-effect" href="javascript:void(0)" onclick="$('#app').load('./user/maintenance.php?q='+encodeURI('Prune your plants'))">View More</a> </div> </div> </div> <div class="col s12 m6"> <div class="card mcard"> <div class="card-image"> <img class="materialboxed"  src="https://www.mollymaid.com/images/blog/Vinegar-vs-Descaler-9-17.jpg"> </div> <div class="card-content"> <span class="card-title">Descale Coffee maker</span> <p>Make sure you descale your coffee maker every year!</p> </div> <div class="card-action"> <a class="btn-round btn btn-flat waves-effect" href="javascript:void(0)" onclick="$('#app').load('./user/maintenance.php?q='+encodeURI('Descale Coffee maker'))">View More</a> </div> </div> </div> </div>
  <?php
      break;
    case "Sep":
  ?>
