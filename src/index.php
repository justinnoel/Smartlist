...
<html>
  ...
  <body>
    ...
    <nav class="sticky top-0 z-10 bg-white shadow-sm py-4 px-4 flex w-full">
      <a href="/" class="text-gray-500 flex items-center py-1 px-3 rounded-md"
        ><img
        ...
        /><span class="text-gray-500 text-lg mx-1.5">Smartlist</span></a
      >
      <a
        href="//community.smartlist.ga"
        class="hidden lg:flex hover:bg-blue-50 hover:text-blue-900 text-gray-500 items-center py-1 px-3 focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded-md"
        >Community Forum</a
      >
      <a
        href="//support.smartlist.ga"
        class="hover:bg-blue-50 focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 hover:text-blue-900 text-gray-500 hidden lg:flex md:flex items-center py-1 px-3 rounded-md focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
        >Knowledge Base</a
      >
      <a
        href="//smartlist.ga/developer"
        class="hover:bg-blue-50 hover:text-blue-900 text-gray-500 flex items-center py-1 px-3 rounded-md focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
        >Developer</a
      >
			<a
        href="https://discord.gg/QDwxp7qrf2"
        class="hover:bg-blue-50 hidden lg:flex hover:text-blue-900 text-gray-500 flex items-center py-1 px-3 rounded-md focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
        >Discord</a
      >
      <a
        href="/impact"
        class="hover:bg-blue-50 hover:text-blue-900 text-gray-500 hidden lg:flex md:flex items-center py-1 px-3 rounded-md focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
        >Our Impact</a
      >
      <a
        href="//support.smartlist.ga"
      ...
      <a
        ...
        class="float-right hover:bg-blue-50 hover:text-blue-900 text-gray-500 flex items-center ml-auto py-1 px-3 rounded-md focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
        >Login</a
      >
    </nav>
    <main class="container mx-auto px-10 py-20 lg:py-40">
      <div class="text-center grid-cols-1 lg:grid-cols-2 grid lg:text-left">
        <div class="bg1">
          <h1
            class="slide text-4xl tracking-tight text-gray-900 sm:text-5xl md:text-6xl mt-5"
          >
            <span class="e">
							Smart and easy
          ...
          <h2
            class="text-1xl tracking-tight text-gray-900 sm:text-2xl md:text-1xl mt-5 lg:mt-8 slide"
          >
						<span class="e">
          ...
          <a
            ...
            class="text-black focus:ring-2 focus:ring-green-500 focus:ring-offset-2 sm:-mr-2 px-6 rounded-md py-4 inline-block mt-5 mr-2 bg-green-50 wow fadeInUp"
            >Watch the video</a
          >
        </div>
        <div class="pl-10 lg:block hidden">
					<div class="absolute bg-white p-5 shadow-lg hover:shadow-xl rounded-lg m-5">
						<b>Kitchen</b><br>
          ...
          <img src="https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F37%2F2021%2F09%2F17%2Fexterior-house-amidst-trees-B-25f1YeaKTBoqHHXymzSw.jpg" class="rounded-full w-full h-auto" alt="" />
					<div class="relative inline-block hover:shadow-xl float-right bg-white p-5 shadow-md rounded-lg text-right" style="margin:-15px;margin-top: -50px;top:-10px;">
...
<div
	...
	>
	<div class="shadow-md rounded-lg p-5 hover:shadow-lg wow fadeInUp">
		<h5 class="font-bold text-2xl"><?=thousandsCurrencyFormat($userCount)?></h5>
		<p class="gray-text-500">Accounts</p>
	</div>
	<div class="shadow-md rounded-lg p-5 hover:shadow-lg wow fadeInUp" data-wow-delay=".10s">
		<h5 class="font-bold text-2xl"><?=thousandsCurrencyFormat($itemCount);?></h5>
		<p class="gray-text-500">Items created</p>
	</div>
	<div class="shadow-md rounded-lg p-5 hover:shadow-lg wow fadeInUp" data-wow-delay=".20s">
		<h5 class="font-bold text-2xl">$<?=thousandsCurrencyFormat($financeCount)?></h5>
		<p class="gray-text-500">Expenses logged</p>
	</div>
</div>
      <div class="text-center mt-20">
        <h2 class="text-2xl text-gray-800 wow fadeInUp">In a nutshell, Smartlist...</h2>
      </div>
      <center>
        <div
          class="grid lg:grid-cols-6 gap-5 grid-cols-2 mt-16 md:grid-cols-2 lg:w-7/8 inline-block text-gray-700"
        >
			...
			<div class="container mx-auto px-10 py-10 lg:py-25">
				<div class="grid grid-cols-1 lg:grid-cols-2">
					<div class="pt-10 pb-10">
						<h3 class="text-2xl tracking-tight text-gray-900 sm:text-2xl md:text-3xl mt-5 wow fadeInUp">Smart and intuitive</h3>
						<p class="mb-3 mt-2 wow fadeInUp">Our app is designed for anyone and everyone to use. Accessible to all.</p>
						<p class="mb-4 wow fadeInUp"><b>What's your favorite color?</b></p>
		...
		<div class="py-10 container mx-auto px-10 py-20 lg:py-20">
			<div class="text-center py-10 pb-0 text-gray-800">
				<h2 class="text-2xl text-gray-800 wow fadeInUp">Why do our customers love Smartlist so much?</h2>
			</div>
			 <center>
        <div
          class="grid lg:grid-cols-4 gap-4 grid-cols-2 mt-5 mb-10 md:grid-cols-2 lg:w-4/5 inline-block text-gray-700"
        >
          <div class="wow fadeInUp">
            <div class="p-1 border-gray-200 rounded-t-full">
              <i
  ...
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
    ...
    <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
      ...
      <div class="ml-3 inline-flex rounded-md shadow">
        <a href="//blog.manuthecoder.ml/smartlist" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-green-600 bg-white hover:bg-green-50 focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
          Learn more
        </a>
      </div>
    </div>
		...
		<div class="m-4 wow fadeInUp" style="border-top:1px solid #E5E7EB">
			<div
				...
				<div class="grid-cols-1 lg:grid-cols-2 md:grid-cols-2 grid" style="width:100%">
					<div class="lg:w-1/2">
						...
						<form action="" class="mt-2">
							...
							<div>
								<input name="email" type="email" autocomplete="off" required class="px-5 py-3 rounded-4 border-gray-300 border-2 rounded-md mb-2 focus:border-green-600 focus:text-green-600 text-gray-400 mr-1" placeholder="Enter your email here...">
