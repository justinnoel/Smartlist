...
<html>
  ...
  <body class="dark:bg-slate-800">
    ...
    <nav class="sticky top-0 z-10 bg-white shadow-sm py-4 px-4 flex w-full dark:bg-slate-700">
      ...
      <a
        href="/security"
        class="bg-blue-50 dark:bg-slate-900 hover:text-blue-900 dark:hover:text-white text-gray-500 dark:text-white flex items-center py-1 px-3 rounded-md focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
        >Privacy</a
      >
      <a
      ...
      >
            ...
            <main class="container mx-auto px-10 py-20 lg:py-40 overflow-x-hidden dark:text-white">
            <div class="text-center">
                <div class="bg1">
                    ...
                    >
                        <span class="e">
                        <span class="e text-green-600">Privacy</span>
                        </span>
                    </h1>
                    <h2
                        class="text-1xl tracking-tight text-gray-900 sm:text-2xl md:text-1xl mt-5 lg:mt-8 slide dark:white-text"
                    >
                        <span class="e">
                        Learn <span class="e">how <span class="e">your <span class="e">data <span class="e">is <span class="e">secure</span></span></span></span></span></span>
                        </span>
                    </h2>
                </div>
            </div>
            <div class="text-center p-5 mb-10 mt-40 rounded-lg wow fadeInUp">
                <h2 class="text-4xl">
                    Features
                </h2>
            </div>
            <div class="grid gap-1 items-cendter grid-cols-1 lg:grid-cols-2 mt-5 dark:white-text" class="w-full">
                <div class="p-2">
                    <h1 class="text-3xl wow fadeInLeft">Data processing</h1>
                </div>
                <div class="p-2">
                    <p class="wow fadeInUp lg:text-right">Input > Sanitization > Strip unsafe scripts > Encryption > Storage > (Request to view items)> Decryption > Strip HTML, and other code > Output</p>
                </div>
            </div>
            <div class="grid gap-1 items-cendter grid-cols-1 lg:grid-cols-2 mt-5" class="w-full">
                <div class="p-2">
                    <h1 class="text-3xl wow fadeInLeft">Encryption</h1>
                </div>
                <div class="p-2">
                    <p class="wow fadeInUp lg:text-right">Your data is encrypted with 256-bit AES encryption <br>End-to-end encrypted <br>Encrypted items <br>Encrypted accounts, tasks, and shopping lists</p>
                </div>
            </div>
            
            <div class="grid gap-1 items-cdenter grid-cols-1 lg:grid-cols-2 mt-5" class="w-full">
                <div class="p-2">
                    <h1 class="text-3xl wow fadeInLeft">Hashing</h1>
                </div>
                <div class="p-2">
                    <p class="wow fadeInUp lg:text-right">Your account is stored using Argon2 hashing</p>
                </div>
            </div>
            <div class="grid gap-1 items-cendter grid-cols-1 lg:grid-cols-2 mt-5" class="w-full">
                <div class="p-2">
                    <h1 class="text-3xl wow fadeInLeft">Code security</h1>
                </div>
                <div class="p-2">
                    <p class="wow fadeInUp lg:text-right">SQL prepared statements <br>Updated code <br>XSS proof</p>
                </div>
            </div>

            <div class="grid gap-1 items-cendter grid-cols-1 lg:grid-cols-2 mt-5" class="w-full">
                <div class="p-2">
                    <h1 class="text-3xl wow fadeInLeft">Other measures</h1>
                </div>
                <div class="p-2">
                    <p class="wow fadeInUp lg:text-right">HSTS policy<br>HTTPS security<br>Strict origin server security<br>SSL certificate<br>DDoS protection</p>
                </div>
            </div>
