...
foreach ($users as $row)
{
print "<li class=\"collection-item\" ".($row['name'] == $_POST['query'] ? 'style="border-left: 4px solid #1b5e20 !important"' : "")." onclick=\"change_title('Kitchen');sm_page('Contact');AJAX_LOAD('#Contact', './rooms/kitchen/view.php');\">
...
print "<li class=\"collection-item\" ".($row['name'] == $_POST['query'] ? 'style="border-left: 4px solid #1b5e20 !important"' : "").">
        ".($row['star'] == "1" ? '<i class="material-icons-round right">star</i>' : "")."
            ...
            <b><a href='javascript:void(0)' onclick=\"change_title('Garage');sm_page('About');AJAX_LOAD('#About', './rooms/garage/view.php')\">". htmlspecialchars($row["name"]). "</a></b>
            <br><span>Garage</span>
       </li>";
}
$dbh = null;
...
print "<li class=\"collection-item\" ".($row['name'] == $_POST['query'] ? 'style="border-left: 4px solid #1b5e20 !important"' : "").">
        ".($row['star'] == "1" ? '<i class="material-icons-round right">star</i>' : "")."
            ...
            <b><a href='javascript:void(0)' onclick=\"change_title('Bedroom');sm_page('Home');AJAX_LOAD('#Home', './rooms/bedroom/view.php')\">". htmlspecialchars($row["name"]). "</a></b>
...
print "<li class=\"collection-item\" ".($row['name'] == $_POST['query'] ? 'style="border-left: 4px solid #1b5e20 !important"' : "").">
        ".($row['star'] == "1" ? '<i class="material-icons-round right">star</i>' : "")."
            ...
            <b><a href='javascript:void(0)'onclick=\" change_title('Bathroom');sm_page('bathroom');AJAX_LOAD('#bathroom', './rooms/bathroom/view.php')\">". htmlspecialchars($row["name"]). "</a></b>
...
print "<li class=\"collection-item\" ".($row['name'] == $_POST['query'] ? 'style="border-left: 4px solid #1b5e20 !important"' : "").">
        ".($row['star'] == "1" ? '<i class="material-icons-round right">star</i>' : "")."
            ...
            <b><a href='javascript:void(0)' onclick=\"change_title('Family Room');sm_page('family');AJAX_LOAD('#family', './rooms/family/view.php')\">". htmlspecialchars($row["name"]). "</a></b>
...
print "<li class=\"collection-item\" ".($row['name'] == $_POST['query'] ? 'style="border-left: 4px solid #1b5e20 !important"' : "").">
        ".($row['star'] == "1" ? '<i class="material-icons-round right">star</i>' : "")."
            ...
            <b><a href='javascript:void(0)' onclick=\"change_title('Storage Room');sm_page('storage');AJAX_LOAD('#storage', './rooms/storage/view.php')\">". htmlspecialchars($row["name"]). "</a></b>
...
{
print "<li class=\"collection-item\" ".($row['name'] == $_POST['query'] ? 'style="border-left: 4px solid #1b5e20 !important"' : "").">
            <b><a href='javascript:void(0)' onclick=\"load_croom('" . str_replace('"', '', str_replace("'", "", $row['price'])) . "', '" . str_replace('"', '', str_replace("'", "", $row['name'])) . "')\"\">". htmlspecialchars($row["name"]). "</a></b>
