<?php 
session_start();
// 85e36899399df701301f6741ffab57962a14326584b6f082ae0e87d90e492fd4
if(isset($_SESSION['valid'])) {
try {
$dbname = "bcxkspna_test";
$c_db = "bcxkspna_contributor";
$api_db = "bcxkspna_smartlist_api";
$dbh = new PDO("mysql:host=$servername;dbname=$api_db", $username, $password);
$sql = "SELECT * FROM api_keys WHERE qty='".$_GET['key']."'";
$users = $dbh->query($sql);
...
header("Location: ".$url."&username=".$_SESSION['name']);
exit;
}
try {
...
header("Location: ".$url."&username=".$_SESSION['username']);
      } else {
...
<form method="post">
    ...
    <div class="input-container">
        ...
        <button type="submit" name="submitBtnLogin" id="submitBtnLogin" value="Login" onclick="var e=this;setTimeout(function(){e.disabled=true;},10);return true;" class="btn"/>Login</button><br><br><hr>
        </div>
        </div>
