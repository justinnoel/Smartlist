...
foreach ($users as $row)
{
    ...
    $_SESSION['houseName'] = "";
    if(!empty($row['houseName'])) $_SESSION['houseName'] = decrypt($row['houseName']);
...
if (empty($theme) || !isset($theme)) {
    // Default theme if invalid or empty in database
    $theme = '41308a';
}
...
function sanitize_output($buffer) {
    // Minifies the output
    require_once '/home/smartlis/public_html/dashboard/lib/Minify/HTML.php';
...
<html lang="en">
  <head>
    <script>if(localStorage.getItem("theme")&&localStorage.getItem("theme")=="true"){document.documentElement.classList.add("_darkTheme");document.head.insertAdjacentHTML('beforeend', `<meta name="color-scheme" content="light dark" />`)}</script>
    <title>Dashboard</title>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js" integrity="sha512-qTXRIMyZIFb8iQcfjXWCO8+M5Tbc38Qi5WzdPOYZHIlZpzBHG3L3by84BBBOiRGiEb7KKtAOAs5qYdUiZiQNNQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>    
    <link rel="preload" href="./css/style.css" as="style"> <link rel="preload" href="./js/main.js" as="script"> <link rel="preload" href="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js" as="script"> <link rel="preload" href="https://cdn.jsdelivr.net/npm/@materializecss/materialize@1.1.0-alpha/dist/css/materialize.min.css" as="style">
    ...
    #app table,i,.btn,button {user-select: none}
      :root { --sidenav-bg-color-m3:#fff;--font-color: #303030; --light: #<?=$theme_light; ?>; --regular: #<?=$theme; ?>; --bg-color: #fff; --sidenavf-color: #7a7a7a; --sidenavbg-color: <?=$overlayColor; ?>; --navbar-color: #<?=$theme; ?>; --sidenavbg1color: #fff; --x: 0px }
  ...
  <ul class="right">
    ...
    <div id="avatarChange" class="modal">
      <div class="modal-content">
        <center> <img class="circle" src="<?=$_SESSION['avatar']; ?>" class="center" style="width: 100px" id="src" alt=""> </center>
    ...
    <ul id="slide-out" class="z-depth-1 sidenav sidenav-fixed" style="background:var(--sidenav-bg-color-m3)!important;z=index: 99999999999999999999999999999999">
      ...
      <li><div class="user-view hide-on-med-and-down">
        ...
        <a href="#avatarChange" style="margin-bottom: none !important;border-radius: 999px;overflow:hidden;" data-position="bottom" data-tooltip="Change your profile picture" class="waves-esffect tooltipped modal-trigger avatar"><img class="circle" src="<?=$_SESSION['avatar']; ?>" alt=""></a>
...
{ ?>
      ...
      <li class="links"><a tabindex="0" target="_blank" class="waves-effect sidenav-close" rel="noopener" href="https://collaborate.smartlist.ga"><i class="material-icons-round">event_available</i>Join event</a></li>
      <li class="links"><a tabindex="0" target="_blank" class="waves-effect sidenav-close" rel="noopener" href="https://collaborate.smartlist.ga/create-event"><i class="material-icons-round">edit_calendar</i>Create
        event</a></li>
      <li style="pointer-events:none"> <div class="divider"></div> </li>
      <?php
} ?>
    ...
    <div id="_feedback" class="modal bottom-sheet" style="border-top-left-radius: 10px!important;border-top-right-radius:10px!important"> <div class="modal-content"> <div class="center"><h5 style="margin-top: 25px">Feedback</h5> <p>Have any questions, concerns, or feature requests? We're all ears!</p> </div><form id="feedback-form" action="https://formspree.io/f/mbjqjeyo" method="POST"> <input type="hidden" name="email" value="manuthecoder@protonmail.com" /> <input type="hidden" name="login_id" value="1" /> <label>Message:</label> <textarea required class="materialize-textarea" name="message"></textarea> <div style="text-align:right"><button id="my-form-button" class="waves-effect btn blue-grey darken-3 waves-light btn-round"><i class="material-icons left">send</i>Send</button></div> <p id="my-form-status"></p> </form> </div> </div>
    ...
    <div id="bmmodal" class="modal modal-fixed-footer">
      <nav style="background: var(--bg-color) !important" class="z-depth-0">
        <ul>
          <li><a href="javascript:void(0)" class="hide-on-med-and-up modal-close"><i class="material-icons spin" style="color: var(--font-color);margin:0!important;padding:0!important">close</i></a></li>
      ...
      <form onsubmit="bm_add();if(document.getElementById('financeCircleIndicator')) {document.getElementById('financeCircleIndicator').remove();}M.toast({html: 'Added data successfully!'});return false;" method="post" name="form1"> 
        ...
        <div class="fixed-action-btn">
          <button type="submit" name="Submit" class="btn btn-round waves-effect waves-light blue-grey darken-3"><i class="material-icons">save</i></button>
        </div>
      </form>
    </div>
    <div class="fixed-action-btn">
      <a class="black-text btn-large waves-effect modal-trigger" href="#addItem" id="fab" style="overflow:hidden;background: var(--sidenav-bg-color-m3)!important">
    ...
    <div id="addItem" class="modal bottom-sheet" onscroll="this.style.maxHeight = '95vh!important';this.style.height = '95vh!important';this.style.minHeight = '95vh!important'">
      ...
      <div class="center"><h5 style="margin-top: 30px;">Create new</h5></div>
        ...
        <div class="row" style="overflow: visible!important;margin:0!important">
          <a style="overflow:visible!important;border-radius:28px;border:0!important;color:var(--font-color)!important" class="col s3 card-panel z-depth-0 transparent card center modal-close avatar" onclick="window.location.hash = '#/add/family'"><i class="waves-effect border-icon darken-3 circle material-icons">dining</i><br><h6 class="truncate">Dining</h6></a>
          ...
          <a style="overflow:visible!important;border-radius:28px;border:0!important;color:var(--font-color)!important" class="col s3 card-panel z-depth-0 transparent card center modal-close avatar" onclick="window.location.hash = '#/add/family'"><i class="waves-effect border-icon darken-3 circle material-icons">local_laundry_service</i><br><h6 class="truncate">Laundry</h6></a>
...
catch(PDOexception $e)
{
    ...
    <div id="right_click_modal" class="hide z-depth-4" onclick="this.classList.add('hide')"> <a href="javascript:void(0)" id="rclick_edit" class="modal-close waves-effect"><i class="material-icons-round left">edit</i> Edit</a> <a href="javascript:void(0)" id="rclick_add" class="modal-close waves-effect"><i class="material-icons-round left">local_grocery_store</i> Add to Shopping List</a> <a href="javascript:void(0)" id="rclick_share" class="modal-close waves-effect"><i class="material-icons-round left">share</i> Share</a> <a href="javascript:void(0)" id="rclick_recipe" target="_blank" class="modal-close waves-effect"><i class="material-icons-round left">auto_awesome</i> Find recipe</a> <a href="javascript:void(0)" id="rclick_mail" target="_blank" class="modal-close waves-effect"><i class="material-icons-round left">email</i> Email</a><a href="javascript:void(0)" id="rclick_qr" target="_blank" class="waves-effect"><i class="material-icons-round left">qr_code</i> Generate QR code</a> <a href="javascript:void(0)" id="rclick_delete" class="modal-close waves-effect"><i class="material-icons-round left">delete</i> Delete</a> </div>
    ...
    <script async>
      ...
      function getHashPage(e = "") {
        ...
        switch(window.location.hash.replace("#", "")) {
          ...
          case "/user-dashboard": url = "./pages/dashboard.php"; break; case "/rooms/kitchen": url = "./rooms/kitchen/view.php"; break; case "/rooms/bedroom": url = "./rooms/bedroom/view.php"; break; case "/rooms/bathroom": url = "./rooms/bathroom/view.php"; break; case "/rooms/garage": url = "./rooms/garage/view.php"; break; case "/rooms/family": url = "./rooms/family/view.php"; break; case "/rooms/storage": url = "./rooms/storage/view.php"; break; case "/rooms/dining": url = "./rooms/dining_room/view.php"; break; case "/rooms/camping": url = "./rooms/camping/view.php"; break; case "/rooms/laundry": url = "./rooms/laundry/view.php"; break;
          case "/add/kitchen": url = "./rooms/kitchen/quickadd.php"; break; case "/add/bedroom": url = "./rooms/bedroom/quickadd.php"; break; case "/add/bathroom": url = "./rooms/bathroom/quickadd.php"; break; case "/add/garage": url = "./rooms/garage/quickadd.php"; break; case "/add/family": url = "./rooms/family/add1.php"; break; case "/add/storage": url = "./rooms/storage/quickadd.php"; break; case "/add/custom-room": url = 'https://smartlist.ga/dashboard/rooms/custom_room/add_room.php'; break; case "/add/dining": url = "./rooms/dining_room/quickadd.php"; break; case "/add/camping": url = "./rooms/camping/quickadd.php"; break; case "/add/laundry": url = "./rooms/laundry/quickadd.php"; break; case "/add/shopping-list": url = "./rooms/grocerylist/quickadd.php"; break; case "/add/reminder": url = "./rooms/todo/quickadd.php"; break; case "/add/subscription": url = "./user/finance/subscription_quickadd.php"; break;
