...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content="Smartlist, Smartlist dashboard, Smart List, List, Inventory, Home, Smartlist app, Smart list app, Smartlist Dashboard, Smartlist login, Smartlist Signup, Smart list login, Smart list sign up, Smart list signup, smart list register, Smartlist logo, smartist, smarst, smatist, free home inventory app, home inventory app, free app, inventory, free, smartlist, free, home, inventory, app, my home, keep track of what you have in your home for free">
  ...
  <body>
    <nav class="white" id="navbar">
      ...
      <ul class='right'>
        ...
        <li><a class="hide-on-small-only" href="./status/">Server Status <div class="green circle"></div></a></li>
