...
<div class="container" style="width: 95% !important">
  ...
  <div class="card">
    ...
    <?php if (!$noExpenses) { ?>
      ...
      <b><h5 style="margin: 5px 0;margin-bottom: 15px"><b>My expenses</b> &nbsp;<?php if (
          intval($moneyToday) === 0
      ) {
          ...
          echo '<i class="material-icons green-text tooltipped" data-tooltip="Expenses are below your goal" style="vertical-align: middle">mood</i>';
      }} ?></h5></b>
      ...
      <div class="card">
        <div class="card-content">
          ...
          <p style="margin-bottom: 10px;">
            <label>
              <input type="checkbox" oninput="if(confirm('Delete?') === true) {$('#ajaxLoader').load('https://smartlist.ga/dashboard/rooms/grocerylist/delete.php?id=<?= $row[
                  "id"
              ] ?>', () => {this.parentElement.parentElement.style.color = 'red !important'})}"/>
    ...
    <div class="col s12 m6" style="padding: 3px !important">
      <div class="card">
        <div class="card-content">
          ...
          <p style="margin-bottom: 10px;">
            <label>
              <input type="checkbox" oninput="if(confirm('Delete Task?') === true) {$('#ajaxLoader').load('https://smartlist.ga/dashboard/rooms/todo/delete.php?id=<?= $row[
                  "id"
              ] ?>', () => {this.parentElement.parentElement.style.color = 'red !important'})}"/>
