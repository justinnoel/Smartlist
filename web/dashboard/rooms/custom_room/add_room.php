...
try {
  ...
  header("Location: https://smartlist.ga/dashboard/test.php?croom");
...
<div class="row">
    <div class="col s12">
            <input name="name" placeholder="Room name" required autofocus><br>
    </div>
    <div class="col s8 m9">
            <input placeholder="Choose icon..." value="label" required name="icon" readonly id="icon1"><br>
</div>
