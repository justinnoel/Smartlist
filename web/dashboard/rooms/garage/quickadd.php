...
<div class="container">
  <form action="https://smartlist.ga/dashboard/rooms/garage/add.php" method="POST" id="garage_add_form">
    ...
    <div class="input-field">
      <label>Name</label>
      <input type="text" name="name" class="validate autocomplete" id="addGarageName" autofocus data-length="150" autocomplete="off" required>
    </div>
    ...
    <div class="input-field">
      ...
      <input type="text" name="qty" class="validate" autocomplete="off" required data-length="20" id="addGarageQty">
