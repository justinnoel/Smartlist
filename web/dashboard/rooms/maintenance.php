...
<div class="container">
  <div class="row">
    <div class="col s12 m6">
      ...
      <br>
      <button onclick="$('#ajaxLoader').load('./rooms/todo/addToTask.php?q=' + encodeURI('<?php echo $q; ?>'))" class="btn blue-grey darken-3 addToTask waves-effect waves-light">Add to todo list</button>
