      ...
      <?php try
{
  ...
  foreach ($users as $numbervarnotify)
  {
    ...
    {
      echo ' <li class="collection-item avatar"> <i class="material-icons circle waves-effect blue darken-3" style="color:white !important">countertops</i> <span class="title"><b>Kitchen</b></span> <p>You\'re going to run out of ';
      ...
      } ?> <?php try
{
  ...
  foreach ($users as $numbervarnotify)
  {
    if (preg_replace("/[^0-9]/", "", $numbervarnotify['qty']) < $number_notify)
    {
      echo ' <li class="collection-item avatar"> <i class="material-icons circle waves-effect pink darken-3" style="color:white !important">tv</i> <span class="title"><b>Family Room</b></span> <p>You\'re going to run out of ';
      echo $numbervarnotify['name'];
      echo " soon</p></li>";
    }
  }
