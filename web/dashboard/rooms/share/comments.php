        ...
        if ($comment['parent_id'] == $parent_id) {
            ...
            <div class="comment card">
                <div class="card-content">
                    ...
                    <span class="date right">' . time_elapsed_string($comment['submit_date']) . '</span>
...
<div class="comment_header">
    ...
    <a href="#" class="write_comment_btn btn waves-effect waves-light" data-comment-id="-1">Add A Comment</a>
</div>
