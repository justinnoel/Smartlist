...
<html lang="en">
  ...
  <div id="budgetmetermodala" class="modal modal-fixed-s  bottom-sheet"  style="width:60%"> <div class="modal-content modal-close" id="CTRLS_CTNT" style="cursor: auto"> <b><h5 class="center">Add an item <span class="hide-on-med-and-down">(CTRL S)</span></h5></b> <p class="center">Please select a room</p> <div class="collection"> <a onclick="sm_page('addkitchen');AJAX_LOAD('#addkitchen', './rooms/kitchen/quickadd.php')" class="collection-item waves-effect modal-close"><i class="material-icons-round left">countertops</i>Kitchen</a> <a href="javascript:void(0)" onclick="sm_page('bedroom_add');AJAX_LOAD('#bedroom_add', './rooms/bedroom/quickadd.php')" class="collection-item waves-effect"><i class="material-icons-round left">bed</i>Bedroom</a> <a href="javascript:void(0)"onclick="sm_page('bathroom_add');AJAX_LOAD('#bathroom_add', './rooms/bathroom/quickadd.php')" class="collection-item waves-effect"><i class="material-icons-round left">wc</i>Bathroom</a> <a onclick="sm_page('garage_add');setTimeout(function(){ sm_page('garage_add');document.getElementById('garage_name_input').focus() }, 0500);"  class="modal-close collection-item waves-effect"><i class="material-icons-round left">build</i>Garage</a> <a onclick="AJAX_LOAD('#add_family', './rooms/family/add1.php');sm_page('add_family')" href="javascript:void(0)" class="collection-item waves-effect"><i class="material-icons-round left">tv</i>Family</a> <a href="javascript:void(0)" onclick="AJAX_LOAD('#storage_add', './rooms/storage/quickadd.php');sm_page('storage_add')" class="collection-item waves-effect"><i class="material-icons-round left">business</i>Storage Room</a> <a href="javascript:void(0)" onclick="sm_page('dining_room_add'); AJAX_LOAD('#dining_room_add', './rooms/dining_room/quickadd.php')" class="collection-item waves-effect"><i class="material-icons-round left">restaurant</i>Dining Room</a><a href="javascript:void(0)" onclick="AJAX_LOAD('#camping_add', './rooms/camping/quickadd.php'); sm_page('camping_add')" class="collection-item waves-effect"><i class="material-icons-round left">landscape</i>Camping Supplies</a> <a href="javascript:void(0)" onclick="sm_page('laundry_room_add'); AJAX_LOAD('#laundry_room_add', './rooms/laundry/quickadd.php')" class="collection-item waves-effect"><i class="material-icons-round left">local_laundry_service</i>Laundry room</a><?php try
{
  $dbh = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
...
<ul id="slide-out" class="sidenav sidenav-fixed">
  ...
  <li class="links"><a class="waves-effect sidenav-close" onclick="sidenav_highlight(this); change_title('Suggested');sm_page('suggested', this);AJAX_LOAD('#suggested', './rooms/suggested.php')"><i class="material-icons-round">assistant</i>Suggested items</a></li>
  ...
  try
  {
    ...
    foreach ($users as $row)
    {
      print "<li class=\"links\"><a href='javascript:void(0)' class=\"waves-effect sidenav-close\" onclick=\"sidenav_highlight(this);change_title('" . str_replace('"', '', str_replace("'", "", $row['name'])) . "');load_croom('" . str_replace('"', '', str_replace("'", "", $row['id'])) . "', '" . str_replace('"', '', str_replace("'", "", $row['name'])) . "')\"><i class='material-icons-round'>" . $row['qty'] . "</i>" . $row["name"] . "</a></li>";
    }
    $dbh = null;
  }
                                                                                              catch(PDOexception $e) { echo "Error is: " . $e->etmessage(); }
  ...
  <li class="links"><a target="_blank" class="waves-effect sidenav-close" rel="noopener" href="https://events.smartlist.ga/"><i class="material-icons-round">event</i>Join event</a></li>
  <li class="links"><a target="_blank" class="waves-effect sidenav-close" rel="noopener" href="https://events.smartlist.ga/dash/event/add.php"><i class="material-icons-round">open_in_new</i>Create event</a></li>
  ...
  <li class="links"><a class="waves-effect " href="#modal1"onclick="sidenav_highlight(this); sm_page('notification_popup');AJAX_LOAD('#notification_popup', './rooms/notifications.php');brandlogotext.innerHTML = 'Inbox'"><i class="material-icons-round">notifications_outline</i>Notifications <span id="badge" class="badge"></span>
    <li class="links"><a class="waves-effect sidenav-close"onclick="sidenav_highlight(this); sm_page('modal1');meta_theme_color('#1f1f1f')"><i class="material-icons-round">settings</i>Settings</a></li>
...
<div id="News" class="tabcontent" style="background:var(--bg-color);color:  background:var(--font-color);animation:tab .2s forwards !important;">
...
{ ?><canvas id="myChart" style="width: 100%" class="ree"></canvas>
  ...
  <div class="row" style="padding: 0 15px">
    ...
    <div class="col s12 m6" style="padding: 10px;padding-bottom:0;">
      ...
      <div class="card" style="border: 2px solid #4caf50;border-radius: 4px">
        <div class="card-content">
...
<nav style="position:fixed;background: #212121;z-index:10000;top:0;display:none;overflow:visible;overflow-y: hidden" id="secondary_nav">
  <div class="nav-wrapper">
    <a href="javascript:void(0)" class="brand-logo left hide-on-large-only" onclick="back();" style="margin: 0 !important"><i class="material-icons-round">arrow_back</i> <span style="font-size: 20px;position: relative;top: -3px;">Details</span></a>
    <ul class="right snav">
...
<div id="item_popup" style="overflow:hidden;animation: fade .2s forwards" class="tabcontent">
  <!--ITEM_POPUP-->
  <div class="container">
    ...
    <div class="collection z-depth-2" style="padding:0" id="item_options">
