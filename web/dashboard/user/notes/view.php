...
<div class="modal-footer" style="background: var(--bg-color);z-index: 2">
  <a onclick="$('#div1').load('./user/notes/delete.php?id=<?=$row['id']; ?>', function() {sm_page('gl'); AJAX_LOAD('#gl', './user/notes/index.php'); change_title('Notes')});" class="left modal-close btn btn-flat  waves-effect"><i class="material-icons">delete</i></a>
