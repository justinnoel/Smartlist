...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        $sql = "INSERT INTO items(name, qty, price, login_id, uname) 
...
<body><br>
    <div class="container">
        ...
        <form action="https://smartlist.ga/dashboard/event/item/add.php" method="POST">
            ...
            <?php if (isset($_GET['todo'])) { ?><div class="input-field"><label>Quantity</label><input type="text" id="qty" name="qty" class="autocomplete_1" autocomplete="off" onkeyup="success()"></div><?php } else { ?><textarea type="text" id="qty" name="qty" class="autocomplete_1 materialize-textarea" autocomplete="off" onkeyup="success()"></textarea><?php } ?>
