...
$users = $dbh->query($sql);
$itemCount = 0;
foreach ($users as $e) {$itemCount += $e["COUNT(name)"]*2;}$dbh = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);


$dbh = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
$sql = "SELECT * FROM login";
$users = $dbh->query($sql);
$userCount = $users->rowCount()*10+2;
  ...
  <body>
    <nav id="navbar" data-aos="fade-in">
      ...
      <ul class='right'>
        ...
        <li><a data-aos="fade-in" data-aos-delay="350" href="./login">Login</a></li>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col s12 m6" style="padding-right: 30px !important;">
          ...
          <br>
          <br>
          <h1 style="font-size: 40px" data-aos="fade-up">Smart and easy <span class="green-text">home inventory</span> management</h1>
          <p data-aos="fade-up" data-aos-delay="100">Smartlist is a free home inventory app that lets you keep track of what you have in your home, and helps you save money. Access your inventory on any device!</p>
          ...
          <a data-aos="fade-up" data-aos-delay="250" href="#vid" class="modal-trigger waves-effect btn-radius btn" style="background:transparent;color:black;border:1px solid black"><i class="material-icons left">play_circle_filled</i>Watch the Video</a>
        </div>
        <div class="col s12 m6 center">
          ...
          <div class="msg" data-aos="zoom-in" data-aos-delay="100" style="width: auto;padding-bottom: 0;">
            <div class="row">
              ...
              <div class="col s3">
                <i class="material-icons" style="font-size: 40px;margin:0;margin-top: 10px;">warning</i>
              </div>
            </div>
          </div>
          ...
          <img alt="Image" src="https://ak1.ostkcdn.com/images/products/is/images/direct/a672f6365786bbb3fd11522ce3a14c460b026c05/Belleze-Modern-Linen-Accent-Chair-Armrest-Living-Room-w--Wood-Leg%2C-Citrine-Yellow.jpg?impolicy=medium" alt="Image" class="circle" style="width: 90%" data-aos="fade-in">
    ...
    <div class="row container">
      <div class="col s12">
        ...
        <div class="row" data-aos="fade-up">
          <div class="col s12 m8" style="padding-top:70px"><h5>Encrypted user data</h5><p>All your items are stored with zero-access encryption! This means, that even if any hacker gets access to our database, all they'll see is just a bunch of random digits and alphanumeric characters!</p></div>
